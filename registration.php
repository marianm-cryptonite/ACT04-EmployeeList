                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter your Department Status" required>
                        </div>
                        ...
                        <div class="input-field">
                            <label>Paydate</label>
                            <input type="number"  placeholder="Enter Paydate">
                        </div>

                        <div class="input-field">
                            <label>Employee Number</label>
                            <input type="number" placeholder="Enter your Employee Number" required>
                        </div>
